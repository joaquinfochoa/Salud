...
export function Encabezado({
  /**
   * Solo el logo, sin navegación.
   *
   * Es lo que llevan entrar, crear cuenta y el alta del profesional: son tres
   * flujos con una sola cosa para hacer, y una barra que ofrece "Buscar" o
   * "Mis turnos" en el medio invita a abandonarlos. El logo alcanza como
   * salida.
   */
  compacto = false,
}: {
