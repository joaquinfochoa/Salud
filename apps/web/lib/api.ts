...
export type Bloqueo = Esquemas["Bloqueo"];
export type BloqueoCreado = Esquemas["BloqueoCreado"];
export type ListaBloqueos = Esquemas["ListaBloqueos"];
export type HorarioSemanal = Esquemas["HorarioSemanal"];
export type ListaHorarios = Esquemas["ListaHorarios"];
export type ListaHuecos = Esquemas["ListaHuecos"];
export type Turno = Esquemas["Turno"];
export type TurnoConProfesional = Esquemas["TurnoConProfesional"];
export type TurnoConPaciente = Esquemas["TurnoConPaciente"];
export type ListaTurnosDePaciente = Esquemas["ListaTurnosDePaciente"];
export type ListaTurnosDeProfesional = Esquemas["ListaTurnosDeProfesional"];
